...
<body>
  <header class="header">
    <h1 class="site-title"><a href="#"><img src="img/LOGO_Founder_or.png" alt="Founder" height="60" ></a></h1>
    <!-- <h1 class="site-title"><a href="#"><video loop autoplay src="video/メイン（ベビーカー）.mp4" alt="Founder"></a></h1> -->
    <a href="cart.php" class="btn btn-cart"><img src="images/common/icon-cart.png" alt="Founder"></a>
  ...
  <div class="main-video">
     <video class="movie"
          loop
          autoplay
          playsinline //動画ファイルが埋め込まれた表示領域で再生
          controls //コントロールボタンloop
          src="video/メイン（ベビーカー）.mp4"
     ></video>
  </div>
